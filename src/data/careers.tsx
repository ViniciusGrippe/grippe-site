const dataCareers = [
  {
    ...
    description:
      'Acting as a designer to refactor and maintain the company`s products, creating websites with Elementor (WordPress) and front-end development with ReactJS (Typescript) with Kanban product.',
